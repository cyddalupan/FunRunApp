...
<div role="main" class="ui-content">
    ...
    <div class="race_category reg4height">
       ...
       <div class="df-font" align="left">
                ...
                <div class="termsboxes">
                    <div class="ui-grid-a">
                        <div class="ui-block-a" style="position:relative;">
                            <label><input type="checkbox" name="termsAndCondition" id="termsAndCondition"> 
                                I Agree to the <span style="color:#fff">Terms & Conditions</span>
                            </label>
							<a href="#termsAndConditions" data-rel="popup" data-position-to="window" data-transition="fade" id="termsbtn">
                                Terms & Conditions
                            </a>                            
                        </div>
                    </div><!-- /grid-a -->
        ...
        <?php page_navigator('registration2','confirm','back_reg4','verify_registration4'); ?>
...
<div data-role="popup" id="termsAndConditions" data-overlay-theme="b" data-theme="a" data-corners="true">
