<div role="main" class="ui-content">
    ...
    <div class="race_category reg1height">
                ...
                <div class="form_centered ">  
                	<div class="inner_form">      
                        <div class="ui-field-contain rnnrsname">
                            ...
                            <div class="clear"></div>
                            <div class="J_firstname"><input type="text" name="text-basic" id="firstname_dv"  placeholder="First Name"></div>
                            <div class="J_midname"><input type="text" name="text-basic" id="middlename_dv"  placeholder="Middle Name"></div>
                            <div class="clear"></div>
                            <div class="J_lastname"><input type="text" name="text-basic" id="lastname_dv"  placeholder="Last Name"></div>
                        </div>
                        ...
                        <div class="ui-grid-a">
                            <div class="ui-block-a mob-num-uni">
                                ...
                                <div data-role="controlgroup" data-type="horizontal">
                                    <select id="mobile-network_dv">
                                        <?php include('all_number_list.php'); ?>
                                    </select>
                                    <input id="mobile-number_dv" type="text" maxlength="7" data-wrapper-class="controlgroup-textinput ui-btn">
                                </div>
                            </div>
                        </div><!-- /grid-a -->
                            ...
                            <div class="ui-block-a mob-num-uni">
                                <div data-role="controlgroup" data-type="horizontal">
                                    <form>
                                        ...
                                        <div class="J_email"><input type="email" data-clear-btn="true" name="email-2" id="user-email_dv" ></div>
                                    </form>
                                </div>
                            </div>
                        </div><!-- /grid-a -->
                        ...
                        <div class="ui-grid-a">
                            <div class="ui-block-a mob-num-uni2">
                                ...
                                <div data-role="controlgroup" data-type="horizontal">
                                    <select id="phone-network_dv">
                                        <?php include('all_landline_list.php'); ?>
                
                                    </select>
                                    <input id="landline-number_dv" type="text" maxlength="7" data-wrapper-class="controlgroup-textinput ui-btn">
                                </div>
                          </div>
                        ...
                        <div class="ui-grid-a">
                            ...
                            <div class="ui-block-b">
                                 <div class="J_dobbox fullwidth">
                                    ...
                                    <div class="J_dob"><input type="date" data-clear-btn="false" name="date-1" id="date-of-birth_dv" value="yyyy-mm-dd"></div>
                                </div><!--J_dobbox-->
                            </div>
                        </div><!-- /grid-a -->
        ...
        <div class="required"><p class="red"></p> </div>
                       ...
                       <?php page_navigator('branch_for_registration_davao','registration2_davao','','verify_registration1_dv'); ?>
