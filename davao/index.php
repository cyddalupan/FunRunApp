<?php 
include('davao/db_connect.php');
include('davao/model.php');
include('davao/function.php');
session_start();
...
<link rel="stylesheet" href="davao/jmobile/jquery.mobile-1.4.4.min.css">
<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Open+Sans:300,400,700">
<script src="davao/jmobile/jquery.js"></script>
<script src="davao/jmobile/jquery.mobile-1.4.4.min.js"></script>
<link rel="stylesheet" href="davao/css/style.css">
<script src="davao/js/javascript.js"></script>
...
<div data-role="page" id="no-longer-available">
  <?php include('davao/no-longer-available.php'); ?>
</div>

<!--home page-->
<div data-role="page" id="home">
  <?php include('davao/home.php'); ?>
</div>
...
<div data-role="page" id="race_category_davao">
  <?php include('race_category_davao.php'); ?>
</div>
...
<div data-role="page" id="branch_for_registration_davao">
  <?php include('branch_for_registration_davao.php'); ?>
</div>
...
<div data-role="page" id="registration1_davao">
  <?php include('registration1_davao.php'); ?>
</div>
...
<div data-role="page" id="registration2_davao">
  <?php include('registration2_davao.php'); ?>
</div>
...
<div data-role="page" id="registration3_davao">
  <?php include('registration3_davao.php'); ?>
</div>
...
<div data-role="page" id="registration4_davao">
  <?php include('registration4_davao.php'); ?>
</div>
...
<!--cyd data-->
<?php  include('davao/mechanics_list.php'); ?>
